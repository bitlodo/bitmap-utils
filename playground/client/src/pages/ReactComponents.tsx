...
export default function ReactComponents() {
    ...
    return (
        <>
            ...
            <span>
                React implementation of <a href='https://bitfeed.live/' target='_blank'>Bitfeed's</a> visualization mode for transactions.
            </span>
            ...
            <div className="card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '10px' }}>
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        style={{ width: '400px', height: '100px', border: 'solid 1px gray', marginTop: '15px' }} 
                    />
